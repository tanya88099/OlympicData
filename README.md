...
2. **Name the Pipeline**: On the right side, it will ask for a pipeline name. Provide a name and click on "Move and transform".
   ![image](https://github.com/user-attachments/assets/20d6db02-c92b-4bd1-9a13-a4c85b52ec88)
   ...
   ![image](https://github.com/user-attachments/assets/1d0c6b21-a462-455f-a9ca-df0f67f44653)
...
1. **Create App Registration**:
   ...
   this code is used to make connection to raw dataset
   ```python
